...
["Webkit","Moz","O","ms"],B=["webkit","moz","o","ms"];d={};var D={},C={},G=[],H=G.slice,z=function(a,b,c,f){var d=e.createElement("div"),g=e.body,u=g||e.createElement("body");if(parseInt(c,10))for(;c--;){var h=e.createElement("div");h.id=f?f[c]:"modernizr"+(c+1);d.appendChild(h)}c=['&#173;<style id="smodernizr">',a,"</style>"].join("");d.id="modernizr";(g?d:u).innerHTML+=c;u.appendChild(d);if(!g){u.style.background="";u.style.overflow="hidden";var n=t.style.overflow;t.style.overflow="hidden";t.appendChild(u)}a=
b(d,a);g?d.parentNode.removeChild(d):(u.parentNode.removeChild(u),t.style.overflow=n);return!!a},N=function(){var a={select:"input",change:"input",submit:"form",reset:"form",error:"img",load:"img",abort:"img"};return function(b,c){c=c||e.createElement(a[b]||"div");b="on"+b;var d=b in c;d||(c.setAttribute||(c=e.createElement("div")),c.setAttribute&&c.removeAttribute&&(c.setAttribute(b,""),d=q(c[b],"function"),q(c[b],"undefined")||(c[b]=x),c.removeAttribute(b)));return d}}(),I={}.hasOwnProperty;var J=
q(I,"undefined")||q(I.call,"undefined")?function(a,b){return b in a&&q(a.constructor.prototype[b],"undefined")}:function(a,b){return I.call(a,b)};Function.prototype.bind||(Function.prototype.bind=function(a){var b=this;if("function"!=typeof b)throw new TypeError;var c=H.call(arguments,1),d=function(){if(this instanceof d){var f=function(){};f.prototype=b.prototype;f=new f;var e=b.apply(f,c.concat(H.call(arguments)));return Object(e)===e?e:f}return b.apply(a,c.concat(H.call(arguments)))};return d});
d.flexbox=function(){return m("flexWrap")};d.canvas=function(){var a=e.createElement("canvas");return!(!a.getContext||!a.getContext("2d"))};d.canvastext=function(){return!(!g.canvas||!q(e.createElement("canvas").getContext("2d").fillText,"function"))};d.webgl=function(){return!!k.WebGLRenderingContext};d.touch=function(){var a;"ontouchstart"in k||k.DocumentTouch&&e instanceof DocumentTouch?a=!0:z(["@media (",v.join("touch-enabled),("),"modernizr){#modernizr{top:9px;position:absolute}}"].join(""),
...
b}function d(b){var c=m[b._html5shiv];c||(c={},L++,b._html5shiv=L,m[L]=c);return c}function e(c,a,f){a||(a=b);if(w)return a.createElement(c);f||(f=d(a));a=f.cache[c]?f.cache[c].cloneNode():O.test(c)?(f.cache[c]=f.createElem(c)).cloneNode():f.createElem(c);return!a.canHaveChildren||n.test(c)||a.tagUrn?a:f.frag.appendChild(a)}function g(b,a){a.cache||(a.cache={},a.createElem=b.createElement,a.createFrag=b.createDocumentFragment,a.frag=a.createFrag());b.createElement=function(c){return E.shivMethods?
e(c,b,a):a.createElem(c)};b.createDocumentFragment=Function("h,f","return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&("+c().join().replace(/[\w\-]+/g,function(b){a.createElem(b);a.frag.createElement(b);return'c("'+b+'")'})+");return n}")(E,a.frag)}function h(c){c||(c=b);var a=d(c);if(E.shivCSS&&!l&&!a.hasCSS){var f=c;var e=f.createElement("p");f=f.getElementsByTagName("head")[0]||f.documentElement;e.innerHTML="x<style>article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}</style>";
e=f.insertBefore(e.lastChild,f.firstChild);a.hasCSS=!!e}w||g(c,a);return c}var k=a.html5||{},n=/^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i,O=/^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i,l,L=0,m={},w;(function(){try{var c=b.createElement("a");c.innerHTML="<xyz></xyz>";l="hidden"in c;var a;if(!(a=1==c.childNodes.length)){b.createElement("a");var f=b.createDocumentFragment();a="undefined"==typeof f.cloneNode||"undefined"==
typeof f.createDocumentFragment||"undefined"==typeof f.createElement}w=a}catch(P){w=l=!0}})();var E={elements:k.elements||"abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output progress section summary template time video",version:"3.7.0",shivCSS:!1!==k.shivCSS,supportsUnknownElements:w,shivMethods:!1!==k.shivMethods,type:"default",shivDocument:h,createElement:e,createDocumentFragment:function(a,f){a||(a=b);if(w)return a.createDocumentFragment();
f=f||d(a);a=f.frag.cloneNode();f=0;for(var e=c(),E=e.length;f<E;f++)a.createElement(e[f]);return a}};a.html5=E;h(b)})(this,e);g._version="2.8.3";g._prefixes=v;g._domPrefixes=B;g._cssomPrefixes=F;g.hasEvent=N;g.testProp=function(a){return A([a])};g.testAllProps=m;g.testStyles=z;g.prefixed=function(a,b,c){return b?m(a,b,c):m(a,"pfx")};t.className=t.className.replace(/(^|\s)no-js(\s|$)/,"$1$2")+(" js "+G.join(" "));return g}(this,this.document);
